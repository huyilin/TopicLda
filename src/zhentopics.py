...
def main():
    ...
    for k in range(0, len(testlambda)):
        ...
        with open('/home/yilin/workspace/data/zhentopics/topic'+str(k)+'.txt','w') as f:
		for i in range(0,30):
...
if __name__ == '__main__':
    open('/home/yilin/workspace/topicmodel/onlineldavb/topics.txt','w').close()
    file2=open('/home/yilin/workspace/topicmodel/onlineldavb/topics.txt','w')
    main()
